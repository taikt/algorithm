 ...
 * 
 * taikt
 * fix bug to use timer on kernel 4.x
 *
 *
 * Ref:
 * --- How to use a timer on kernel 4.x
 * https://elixir.bootlin.com/linux/v4.19-rc5/source/drivers/block/umem.c#L743
 * https://linux.die.net/lkmpg/x1194.html ==> worked on kernel 2.x, not 4.x
 *
 */
