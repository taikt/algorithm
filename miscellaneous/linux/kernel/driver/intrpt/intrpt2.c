/*
 * sudo insmod intrpt2.ko
 * sudo cat /dev/etx_device
 * dmesg
 * TODO: bug do_IRQ: 3.59 No irq handler for vector   
 *
 * Ref:
 ...
 * https://stackoverflow.com/questions/27865075/how-would-one-go-about-generating-artificial-interrupts-in-the-linux-kernel
 *
 * */
...
//static ssize_t sysfs_store(struct kobject *kobj, 
//                struct attribute *attr, char *buf, size_t count);
